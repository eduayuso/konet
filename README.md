...
[![GitHub license](https://img.shields.io/badge/license-Apache%20License%202.0-blue.svg?style=flat)](http://www.apache.org/licenses/LICENSE-2.0) [![Download](https://api.bintray.com/packages/eduayuso/kolibs/konet/images/download.svg) ](https://bintray.com/eduayuso/kolibs/konet/1.1.2) ![kotlin-version](https://img.shields.io/badge/kotlin-1.4.10-orange)
...
buildscript {
    ...
    dependencies {
        classpath "dev.eduayuso.kolibs:konet:1.1.2"
    }
}
